...
namespace NasaBackground
{
    class Program
    {
        private static void Main(string[] args)
        {
            using (var client = new NasaImageClient())
            {
                var searchResults = client.Search(new SearchQuery
                {
                    Query = "planet",
                    MediaType = "image",
                }).Result;
                ...
                {
                    Console.WriteLine("There was a problem contacting the NAS API");
